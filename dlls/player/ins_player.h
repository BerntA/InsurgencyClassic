...
public:
	...
	// Developer Handling
	void SetDeveloper(int iMode = DEVMODE_ON_SILENT);
	bool IsDeveloper(void) { return (m_iDeveloperMode == DEVMODE_ON || m_iDeveloperMode == DEVMODE_ON_SILENT); }
...
private:
	...
	// TrackIR
	CNetworkVar( bool, m_bUsingTrackIR );
	CINSPlayerTrackIRData m_TrackIR;
