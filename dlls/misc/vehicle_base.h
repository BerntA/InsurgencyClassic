...
public:
	// Pongles [
	virtual CBasePlayer *GetDriver( void );
	// Pongles ]
	...
	virtual bool		CanEnterVehicle( CBasePlayer *pEntity );
	virtual bool		CanExitVehicle( CBasePlayer *pEntity );
	...
	virtual void		EnterVehicle( CBasePlayer *pPassenger );

	virtual bool		AllowBlockedExit( CBasePlayer *pPassenger, int nRole ) { return true; }
	virtual bool		AllowMidairExit( CBasePlayer *pPassenger, int nRole ) { return false; }
	virtual void		PreExitVehicle( CBasePlayer *pPassenger, int nRole ) {}
