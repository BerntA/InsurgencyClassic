...
public:
	...
	// Pongles [
	CBasePlayer *GetPassenger( void ) const { return m_hPassenger; }
	// Pongles ]
...
private:
	...
	// Pongles [
	CHandle<CBasePlayer>				m_hPassenger;	// Actual passenger
	// Pongles ]
...
public:
	...
	virtual void			HandlePassengerEntry( CBasePlayer *pPassenger, bool bAllowEntryOutsideZone = false );
	virtual bool			HandlePassengerExit( CBasePlayer *pPassenger );
...
public:
	...
	// Pongles [
	virtual CBasePlayer		*GetDriver( void );	// Player Driving
	// Pongles ]
