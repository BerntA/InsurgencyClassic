...
// Pongles [
// - moved from gamerules since I feel a playing falling won't vary from game to game :P
float CMoveHelperServer::GetPlayerFallDamage( CBasePlayer *pPlayer )
{
...
{
	float flFallDamage = GetPlayerFallDamage( m_pHostPlayer );	
	if ( flFallDamage > 0 )
	{
