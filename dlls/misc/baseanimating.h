...
// Controllers.
	...
	// Fire
	virtual void Ignite( float flFlameLifetime, float flSize = 0.0f, bool bCalledByLevelDesigner = false );
	...
	bool Dissolve( const char *pMaterialName, float flStartTime, int nDissolveType = 0, Vector vDissolverOrigin = vec3_origin, int iMagnitude = 0 );
