...
protected:
	...
	virtual bool	CheckJumpButton( void ) = 0; //deathz0rz	// Overridden by each game.
	...
	virtual void	ClampWalkVelocity( void ) = 0;

	virtual void	DoFallEffects( void ) = 0;
	...
	virtual bool IsSideMoveAllowed( void ) const;

	virtual float	GetStopSpeed( void ) = 0;
