...
static IMaterial *g_pMatAgony = NULL;
...
void CViewRender::RenderPlayerSprites()
{
	...
	// this draws all the HUD panels that need mesh drawing
...
// UNDONE: Clean this up some, handle off-screen vertices
	...
	screen.z = worldToScreen[2][0] * point[0] + worldToScreen[2][1] * point[1] + worldToScreen[2][2] * point[2] + worldToScreen[2][3];
...
ConVar painshader( "r_painshader", "0" );
...
void CViewRender::DoMotionBlur( const CViewSetup &view )
{
    ...
    pTexRenderTarget = materials->GetRenderTarget( );
...
void CViewRender::DrawMotionBlur( const CViewSetup &view, Rect_t actualRect, ITexture *pRenderTarget, ITexture *pBaseTexture, bool bBlurPass = false )
{
    ...
    if( !bBlurPass )
    {
        ...
        materials->DrawScreenSpaceQuad( pMatRender );
    }
    else
    {
