...
#define CONVAR_THIRDPERSON_FLAGS 0

#else

#define CONVAR_THIRDPERSON_FLAGS FCVAR_CHEAT
...
static ConCommand thirdperson( "thirdperson", ::CAM_ToThirdPerson, "Switch to thirdperson camera.", CONVAR_THIRDPERSON_FLAGS );
