...
#define HIDEHUD_VALUE 0

#else

#define HIDEHUD_VALUE FCVAR_CHEAT

#endif

ConVar hidehud( "hidehud", "0", HIDEHUD_VALUE );
...
void CHud::Init( void )
{
	...
	LoadHudTextures( textureList, "scripts/hud_textures", GetEncryptionKey( ) );
	LoadHudTextures( textureList, "scripts/mod_textures", GetEncryptionKey( ) );
...
void CHud::SetupNewHudTexture( CHudTexture *t )
{
	...
	else
	{
		...
		// Pongles [
		CreateTexCoord( t->texCoords, &t->rc, wide, tall );
		// Pongles ]
	}
}
