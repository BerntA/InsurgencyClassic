...
DECLSPEC void sw_setThrowMode(bool throw_errors);
DECLSPEC void sw_setVerboseMode(bool verbose);
DECLSPEC bool sw_getThrowMode(void);
DECLSPEC bool sw_getVerboseMode(void);
