...
void DECLSPEC sw_setThrowMode(bool throw_errors);
void DECLSPEC sw_setVerboseMode(bool verbose);
bool DECLSPEC sw_getThrowMode(void);
bool DECLSPEC sw_getVerboseMode(void);
