...
// Purpose: 
//-----------------------------------------------------------------------------
void ListViewPanel::OnMousePressed(enum MouseCode code)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void ListViewPanel::OnItemMousePressed(ListViewItem* pItem, enum MouseCode code)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void ListViewPanel::OnMouseDoublePressed(enum MouseCode code)
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void ListViewPanel::OnItemMouseDoublePressed(ListViewItem* pItem, enum MouseCode code)
{
	if (code == MOUSE_LEFT)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void ListViewPanel::OnKeyCodeTyped(enum KeyCode code)
{
	if ( m_DataItems.Count() == 0 )
		return;
...
void ListViewPanel::OnKeyTyped(wchar_t unichar)
{
	if (!iswcntrl(unichar))
	{
		...
		char buf[2];
		localize()->ConvertUnicodeToANSI(uniString, buf, sizeof(buf));
