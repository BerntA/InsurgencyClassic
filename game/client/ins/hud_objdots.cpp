...
//=========================================================
//=========================================================
#define OBJDOT_DOT_PATH			"HUD/objdots/dot"
#define OBJDOT_EMPTYDOT_PATH	"HUD/objdots/emptydot"
#define OBJDOT_UNNEEDED_PATH	"HUD/objdots/unneeded"
...
void CObjDots::Think(void)
{
	...
	m_iRequiredToCapture = pObjective->GetPlayersRequired();
