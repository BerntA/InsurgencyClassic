...
public:
	...
	virtual float					GetHealthBarHeightOffset() const { return 0.0f; }
...
public:
	...
	void                AttachmentFollow(CBaseEntity *pBaseEntity, bool bBoneMerge = true, int iAttachment = 0);
	void				FollowEntity(CBaseEntity *pBaseEntity, bool bBoneMerge = true, int iAttachment = 0);
...
public:
	...
	virtual float GetGlowAlpha();
	virtual bool ShouldGlowWhenOccluded();
	virtual bool ShouldGlowWhenUnoccluded();

	virtual int GetGlowMode(void) { return m_iGlowMethod; }
	virtual int GetGlowTeamLink(void) { return m_iGlowTeamLink; }
#endif // GLOWS_ENABLE
