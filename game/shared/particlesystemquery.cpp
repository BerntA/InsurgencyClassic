...
static CollisionGroupNameRecord_t s_NameMap[]={
	...
	{ "ZOMBIE", COLLISION_GROUP_NPC_ZOMBIE },
	{ "CRAWLER", COLLISION_GROUP_NPC_ZOMBIE_CRAWLER },
	{ "ZOMBIEBOSS", COLLISION_GROUP_NPC_ZOMBIE_BOSS },
	{ "MILITARY", COLLISION_GROUP_NPC_MILITARY },
	{ "MERCENARY", COLLISION_GROUP_NPC_MERCENARY },
...
Vector CParticleSystemQuery::GetLocalPlayerPos( void )
{
	...
	return (pPlayer ? pPlayer->WorldSpaceCenter() : vec3_origin);
#endif
}
