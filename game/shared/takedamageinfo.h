...
void CalculateBulletDamageForce(CTakeDamageInfo* info, int iBulletType, float flVelocity, const Vector& vecBulletDir, const Vector& vecForceOrigin, float flScale = 1.0);
