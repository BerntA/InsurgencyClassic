...
{
	//REGISTER_SHARED_ACTIVITY(ACT_INVALID);
	...
	REGISTER_SHARED_ACTIVITY(ACT_TRANS_STAND_CROUCH);
	REGISTER_SHARED_ACTIVITY(ACT_TRANS_STAND_PRONE);
	REGISTER_SHARED_ACTIVITY(ACT_TRANS_CROUCH_STAND);
	REGISTER_SHARED_ACTIVITY(ACT_TRANS_CROUCH_PRONE);
	REGISTER_SHARED_ACTIVITY(ACT_TRANS_PRONE_STAND);
	REGISTER_SHARED_ACTIVITY(ACT_TRANS_PRONE_CROUCH);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_PISTOL);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_KNIFE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_KNIFE);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_GRENADE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_GRENADE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_GRENADE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_GRENADE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_GRENADE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_GRENADE);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_GRENADE);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_DEPLOY_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_M16);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_M16);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_DEPLOY_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_M249);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_M249);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_DEPLOY_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_RPK);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_RPK);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_DEPLOY_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_SKS);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_SKS);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_DEPLOY_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_AK47);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_AK47);
	...
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_AIM_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_WALK_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_RUN_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANR_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_STAND_LEANL_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_SPRINT_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_AIM_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_WALK_SHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_INS_CROUCH_RUN_SHOTGUN);
