...
static char *FMOD_ErrorString(FMOD_RESULT errcode)
{
    switch (errcode)
    {
        ...
        case FMOD_ERR_INTERNAL:               return "An error occured that wasnt supposed to.  Contact support. ";
        ...
        case FMOD_ERR_NEEDSOFTWARE:           return "Tried to use a feature that requires the software engine.  Software engine has either been turned off, or command was executed on a hardware channel which does not support this feature. ";
