...
#ifndef IMATSYSTEMSURFACE_V3_H
#define IMATSYSTEMSURFACE_V3_H
#ifdef _WIN32
#pragma once
#endif
...
class VMatrix;
#include <vgui/vgui.h>
#include "vgui/isurfacev28.h"

namespace MatSystemSurfaceV3
{
...
//
//-----------------------------------------------------------------------------
#define MAT_SYSTEM_SURFACE_INTERFACE_VERSION_3 "MatSystemSurface003"
class IMatSystemSurface : public SurfaceV28::ISurface
{
public:
...
//-----------------------------------------------------------------------------
class IMatSystemSurfaceV3 : public MatSystemSurfaceV3::IMatSystemSurface
{
public:
};
