...
#ifndef ISURFACE_V28_H
#define ISURFACE_V28_H
...
//-----------------------------------------------------------------------------
class ISurface : public IBaseInterface, public IAppSystemV0
{
public:
...
//-----------------------------------------------------------------------------
class ISurfaceV28 : public SurfaceV28::ISurface
{
public:
};


#define VGUI_SURFACE_INTERFACE_VERSION_28 "VGUI_Surface028"

#endif // ISURFACE_V28_H
